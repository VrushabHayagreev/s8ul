 ...
 href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css"/>
   ...
   <div id="profile" className="w-200 lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 py-5 lg:mx-0">
     ...
     <div className="p-4 md:p-12 text-center lg:text-left">
       ...
       <p className="pt-4 text-base text-gray-700 font-bold text-s flex items-center justify-center lg:justify-start"> <i className="fa fa-gamepad text-m text-blue-900"></i>&nbsp;&nbsp;BGMI, Valorant, Among US</p>
