...
const Footer = () => {
  return (
    <>
      <footer
        className="wow fadeInUp relative z-10  dark:bg-[conic-gradient(at_top,_var(--tw-gradient-stops))] from-[#374151] via-[#111827] to-black    pt-16 md:pt-20 lg:pt-24"
        data-wow-delay=".1s"
      >
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                <Link href="/" className="mb-8 dark:shadow-xl dark:shadow-primary inline-block">
                  <Image
                ...
                <p className="mb-9 text-base font-medium leading-relaxed ">
                  S8ul official
                </p>
                <div className="flex items-center">
                  ...
                  <a
                    href="https://www.instagram.com/s8ul.esports/?hl=en"
                    aria-label="social-link"
                    className="mr-6 dark:text-white text-black hover:text-primary"
                  >
                    <svg
                      width="19"
                      height="14"
                  ...
                  <a
                    ...
                    aria-label="social-link"
                    className="mr-6 text-black dark:text-white hover:text-primary"
                  >
                    <svg
                      width="18"
                      height="14"
        ...
        <div className="bg-primary/10 py-8">
          <div className="container">
            <p className="text-center text-base dark:text-white text-black ">
              By Vrushab Hanumesh
            </p>
          </div>
        </div>
