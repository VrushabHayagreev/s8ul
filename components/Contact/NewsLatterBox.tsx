const NewsLatterBox = () => {
  return (
    ...
    >
      ...
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base font-medium leading-relaxed text-black dark:border-white dark:border-opacity-25">
        Enter Your Details
      </p>
      <form>
        <input
        ...
        <input
          type="submit"
          value="Subscribe"
          className="duration-80 mb-4 w-full bg-[#22d3ee] cursor-pointer rounded-md border border-transparent bg-primary py-3 px-6 text-center text-base font-medium text-black outline-none transition ease-in-out hover:bg-opacity-80 hover:shadow-signUp focus-visible:shadow-none"
        />
        <p className="text-center text-base font-medium leading-relaxed text-black">
