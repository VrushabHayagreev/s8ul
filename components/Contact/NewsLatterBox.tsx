const NewsLatterBox = () => {
  return (
    <div
      className="wow fadeInUp relative z-10 shadow-2xl shadow-black dark:shadow-primary dark:bg-[conic-gradient(at_top,_var(--tw-gradient-stops))] from-[#374151] via-[#111827] to-black  rounded-[20px] sm:p-11 lg:p-8 xl:p-11"
      data-wow-delay=".2s"
    >
      <h3 className="mb-4 text-2xl font-bold leading-tight dark:text-white ">
        Subscribe to receive future updates
      </h3>
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base font-medium leading-relaxed dark:text-white dark:border-white dark:border-opacity-25">
        Enter Your Details
      </p>
      <form>
        <input
          ...
          className="mb-4 w-full rounded-md border border-body-color border-opacity-10 py-3 px-6 text-base font-medium dark:text-white placeholder-body-color outline-none focus:border-primary focus:border-opacity-100 focus-visible:shadow-none dark:border-white dark:border-opacity-10 dark:bg-white focus:dark:border-opacity-50"
        />
        <input
          type="email"
          name="email"
        ...
        <input
          type="submit"
          value="Subscribe"
          className="duration-80 mb-4 w-full bg-[#22d3ee] cursor-pointer rounded-md border border-transparent bg-primary py-3 px-6 text-center text-base font-medium dark:text-white outline-none transition ease-in-out hover:bg-opacity-80 hover:shadow-signUp focus-visible:shadow-none"
        />
        <p className="text-center text-base font-medium leading-relaxed dark:text-white">
